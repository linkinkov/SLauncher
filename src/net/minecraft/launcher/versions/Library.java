...
import ru.spark.slauncher.downloader.ForgeLibDownloadable;
...
public class Library {
	...
	public String getArtifactPath(String classifier) {
		...
		return String.format("%s/%s", getArtifactBaseDir(),
	...
	String getArtifactFilename(String classifier) {
		...
		if (classifier == null)
			result = String.format("%s-%s.jar", parts[1],
					parts[2]);
		else
			result = String.format("%s-%s%s.jar", parts[1],
					parts[2], "-" + classifier);
