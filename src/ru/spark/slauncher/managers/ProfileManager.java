...
import ru.spark.slauncher.minecraft.auth.UUIDTypeAdapter;
import ru.spark.slauncher.minecraft.profiles.Profile;
...
public class ProfileManager extends RefreshableComponent {
	public static final String DEFAULT_PROFILE_NAME = "SLauncher";
