...
public class AssetsManager extends LauncherComponent {
	...
	public DownloadableContainer downloadResources(CompleteVersion version,
			List<AssetObject> list, boolean force) {
	...
	private static Set<Downloadable> getResourceFiles(CompleteVersion version,
	...
	List<AssetObject> checkResources(CompleteVersion version,
		...
		List<AssetObject> list, r = new ArrayList<>();
	...
	private static boolean checkResource(File baseDirectory, AssetObject local,
			boolean fast) {
