...
class AuthenticatorService {
	...
	private static void debug(Object... o) { /* log(o); */
	}
	...
	public static String performPostRequest(URL url, String post,
		...
		try {
			...
			debug("Successful read, server response was "
	...
	public static String buildQuery(Map<String, Object> query) {
		...
		for (Map.Entry<String, Object> entry : query.entrySet()) {
			...
			try {
				...
				log("Unexpected exception building query", e);
			}
