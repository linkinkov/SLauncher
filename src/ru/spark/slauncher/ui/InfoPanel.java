...
import ru.spark.slauncher.ui.swing.AnimatorAction;
import ru.spark.slauncher.ui.swing.ResizeableComponent;
import ru.spark.slauncher.ui.swing.editor.EditorPane;
import ru.spark.slauncher.ui.swing.editor.ExtendedHTMLEditorKit;
import ru.spark.slauncher.ui.swing.editor.HyperlinkProcessor;
import ru.spark.slauncher.updater.AdParser;
import ru.spark.slauncher.updater.AdParser.Ad;
...
public class InfoPanel extends CenterPanel implements ResizeableComponent, UpdaterListener, LocalizableComponent {
		...
		if(browser.getEditorKit() instanceof ExtendedHTMLEditorKit)
			((ExtendedHTMLEditorKit) browser.getEditorKit()).setHyperlinkProcessor(new HyperlinkProcessor() {
				...
				private void openServer(String link) throws ParseException {
					...
					VersionManager vm = SLauncher.getInstance().getVersionManager();
	...
	private boolean prepareAd() {
		...
		AdParser.AdList adList = AdParser.adlist;
