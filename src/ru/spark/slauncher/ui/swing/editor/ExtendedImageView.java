...
public class ExtendedImageView extends View {
	private static String base64s = "data:image/", base64e = ";base64,";
	...
	protected void setPropertiesFromAttributes() {
		...
		// Gutters
		borderSize = (short) getIntAttr(HTML.Attribute.BORDER, 0);
	...
	private Image loadNewImage() throws Exception {
		...
		if(source.startsWith(base64s)) {
			...
			String imageType = source.substring(startPoint, startPoint + 4);
